...
func newTbFollow(db *gorm.DB, opts ...gen.DOOption) tbFollow {
	...
	_tbFollow.tbFollowDo.UseDB(db, opts...)
...
func (t tbFollow) clone(db *gorm.DB) tbFollow {
	t.tbFollowDo.ReplaceConnPool(db.Statement.ConnPool)
	return t
}

func (t tbFollow) replaceDB(db *gorm.DB) tbFollow {
...
type ITbFollowDo interface {
	...
	Session(config *gorm.Session) ITbFollowDo
...
func (t tbFollowDo) Session(config *gorm.Session) ITbFollowDo {
