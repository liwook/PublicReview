...
func newTbVoucher(db *gorm.DB, opts ...gen.DOOption) tbVoucher {
	...
	_tbVoucher.Type = field.NewUint32(tableName, "type")
	_tbVoucher.Status = field.NewUint32(tableName, "status")
...
type tbVoucher struct {
	...
	Type        field.Uint32 // 0,普通券；1,秒杀券
	Status      field.Uint32 // 1,上架; 2,下架; 3,过期
...
func (t *tbVoucher) updateTableName(table string) *tbVoucher {
	...
	t.Type = field.NewUint32(table, "type")
...
type ITbVoucherDo interface {
	...
	ReadDB() ITbVoucherDo
	WriteDB() ITbVoucherDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) ITbVoucherDo
...
func (t tbVoucherDo) Session(config *gorm.Session) ITbVoucherDo {
