...
func Use(db *gorm.DB) *Query {
	return &Query{
		db:               db,
		TbBlog:           newTbBlog(db),
		TbBlogComment:    newTbBlogComment(db),
		TbFollow:         newTbFollow(db),
		TbSeckillVoucher: newTbSeckillVoucher(db),
		TbShop:           newTbShop(db),
		TbShopType:       newTbShopType(db),
		TbSign:           newTbSign(db),
		TbUser:           newTbUser(db),
		TbUserInfo:       newTbUserInfo(db),
		TbVoucher:        newTbVoucher(db),
		TbVoucherOrder:   newTbVoucherOrder(db),
	}
}
