...
func newTbShopType(db *gorm.DB, opts ...gen.DOOption) tbShopType {
	_tbShopType := tbShopType{}

	_tbShopType.tbShopTypeDo.UseDB(db, opts...)
	...
	_tbShopType.Sort = field.NewUint32(tableName, "sort")
...
func (t *tbShopType) updateTableName(table string) *tbShopType {
	...
	t.Sort = field.NewUint32(table, "sort")
...
func (t tbShopType) clone(db *gorm.DB) tbShopType {
	t.tbShopTypeDo.ReplaceConnPool(db.Statement.ConnPool)
	return t
}

func (t tbShopType) replaceDB(db *gorm.DB) tbShopType {
...
type ITbShopTypeDo interface {
	...
	ReadDB() ITbShopTypeDo
	WriteDB() ITbShopTypeDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) ITbShopTypeDo
...
func (t tbShopTypeDo) Session(config *gorm.Session) ITbShopTypeDo {
