...
func newTbUserInfo(db *gorm.DB) tbUserInfo {
	_tbUserInfo := tbUserInfo{}

	_tbUserInfo.tbUserInfoDo.UseDB(db)
	...
	_tbUserInfo.Fans = field.NewUint64(tableName, "fans")
	_tbUserInfo.Followee = field.NewUint64(tableName, "followee")
	_tbUserInfo.Gender = field.NewUint8(tableName, "gender")
	_tbUserInfo.Birthday = field.NewTime(tableName, "birthday")
	_tbUserInfo.Credits = field.NewUint64(tableName, "credits")
	_tbUserInfo.Level = field.NewUint8(tableName, "level")
...
type tbUserInfo struct {
	...
	Fans       field.Uint64 // 粉丝数量
	Followee   field.Uint64 // 关注的人的数量
	Gender     field.Uint8  // 性别，0：男，1：女
	Birthday   field.Time   // 生日
	Credits    field.Uint64 // 积分
...
func (t *tbUserInfo) updateTableName(table string) *tbUserInfo {
	...
	t.Fans = field.NewUint64(table, "fans")
	t.Followee = field.NewUint64(table, "followee")
	t.Gender = field.NewUint8(table, "gender")
	t.Birthday = field.NewTime(table, "birthday")
	t.Credits = field.NewUint64(table, "credits")
	t.Level = field.NewUint8(table, "level")
...
func (t tbUserInfoDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) ITbUserInfoDo {
