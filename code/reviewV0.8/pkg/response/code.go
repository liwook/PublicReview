...
var codes = map[int]*ErrorMeta{
	...
	ErrResourceNotFound:      register(http.StatusNotFound, "资源未找到"),
	ErrCreateFailed:          register(http.StatusInternalServerError, "创建失败"),
	ErrDeleteFailed:          register(http.StatusInternalServerError, "删除失败"),
	ErrMoveFailed:            register(http.StatusInternalServerError, "移动失败"),
	ErrCopyFailed:            register(http.StatusInternalServerError, "复制失败"),
	ErrReadFailed:            register(http.StatusInternalServerError, "读取失败"),
	ErrWriteFailed:           register(http.StatusInternalServerError, "写入失败"),
	ErrResourceAlreadyExists: register(http.StatusBadRequest, "资源已存在"),
	ErrDirectoryNotEmpty:     register(http.StatusBadRequest, "目录不为空"),
	ErrSaveFailed:            register(http.StatusInternalServerError, "保存失败"),
	ErrUnauthorized:          register(http.StatusUnauthorized, "未授权"),
}
