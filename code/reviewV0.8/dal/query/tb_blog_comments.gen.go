...
func newTbBlogComment(db *gorm.DB, opts ...gen.DOOption) tbBlogComment {
	...
	_tbBlogComment.Liked = field.NewUint32(tableName, "liked")
	_tbBlogComment.Status = field.NewUint32(tableName, "status")
...
type tbBlogComment struct {
	...
	Status     field.Uint32 // 状态，0：正常，1：被举报，2：禁止查看
...
type ITbBlogCommentDo interface {
	...
	ReadDB() ITbBlogCommentDo
	WriteDB() ITbBlogCommentDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) ITbBlogCommentDo
...
func (t tbBlogCommentDo) Session(config *gorm.Session) ITbBlogCommentDo {
