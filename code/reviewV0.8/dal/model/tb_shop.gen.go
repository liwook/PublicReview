...
type TbShop struct {
	...
	TypeID     uint64    `gorm:"column:type_id;type:bigint unsigned;not null;comment:商铺类型的id" json:"type_id"`                 // 商铺类型的id
	...
	AvgPrice   uint64    `gorm:"column:avg_price;type:bigint unsigned;comment:均价，取整数" json:"avg_price"`                       // 均价，取整数
