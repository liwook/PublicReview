...
type TbBlog struct {
	...
	ShopID     int64     `gorm:"column:shop_id;type:bigint;not null;comment:商户id" json:"shop_id"`                                      // 商户id
	...
	Liked      uint32    `gorm:"column:liked;type:int unsigned;comment:点赞数量" json:"liked"`                                             // 点赞数量
	Comments   uint32    `gorm:"column:comments;type:int unsigned;comment:评论数量" json:"comments"`                                       // 评论数量
