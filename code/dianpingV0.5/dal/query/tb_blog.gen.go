...
func newTbBlog(db *gorm.DB) tbBlog {
	_tbBlog := tbBlog{}

	_tbBlog.tbBlogDo.UseDB(db)
	...
	_tbBlog.Liked = field.NewUint64(tableName, "liked")
	_tbBlog.Comments = field.NewUint64(tableName, "comments")
...
func (t tbBlogDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) ITbBlogDo {
