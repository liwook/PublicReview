...
func newTbVoucherOrder(db *gorm.DB) tbVoucherOrder {
	_tbVoucherOrder := tbVoucherOrder{}

	_tbVoucherOrder.tbVoucherOrderDo.UseDB(db)
	...
	_tbVoucherOrder.PayType = field.NewUint8(tableName, "pay_type")
	_tbVoucherOrder.Status = field.NewUint8(tableName, "status")
...
func (t *tbVoucherOrder) updateTableName(table string) *tbVoucherOrder {
	...
	t.PayType = field.NewUint8(table, "pay_type")
...
func (t tbVoucherOrderDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) ITbVoucherOrderDo {
