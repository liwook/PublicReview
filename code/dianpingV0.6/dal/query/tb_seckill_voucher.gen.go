...
func newTbSeckillVoucher(db *gorm.DB) tbSeckillVoucher {
	_tbSeckillVoucher := tbSeckillVoucher{}

	_tbSeckillVoucher.tbSeckillVoucherDo.UseDB(db)
	...
	_tbSeckillVoucher.Stock = field.NewInt64(tableName, "stock")
...
func (t *tbSeckillVoucher) updateTableName(table string) *tbSeckillVoucher {
	...
	t.Stock = field.NewInt64(table, "stock")
...
func (t tbSeckillVoucherDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) ITbSeckillVoucherDo {
