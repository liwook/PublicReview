...
func newTbShop(db *gorm.DB) tbShop {
	_tbShop := tbShop{}

	_tbShop.tbShopDo.UseDB(db)
	...
	_tbShop.Sold = field.NewUint64(tableName, "sold")
	_tbShop.Comments = field.NewUint64(tableName, "comments")
	_tbShop.Score = field.NewUint64(tableName, "score")
...
type tbShop struct {
	...
	Sold       field.Uint64  // 销量
	Comments   field.Uint64  // 评论数量
	Score      field.Uint64  // 评分，1~5分，乘10保存，避免小数
...
func (t *tbShop) updateTableName(table string) *tbShop {
	...
	t.Sold = field.NewUint64(table, "sold")
	t.Comments = field.NewUint64(table, "comments")
	t.Score = field.NewUint64(table, "score")
...
func (t tbShopDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) ITbShopDo {
